...
export function WelcomeScreen({
  ...
  return (
    <div className="min-h-[100dvh] gradient-hero relative overflow-hidden">
      <div className="orb w-[480px] h-[480px] -top-[120px] -right-[120px]" style={{ background: "hsl(var(--etimad-light-green))" }} />
      <div className="orb w-[360px] h-[360px] -bottom-[80px] -left-[80px]" style={{ background: "hsl(var(--etimad-teal))", animationDelay: "4s" }} />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 md:px-8 pt-12 md:pt-16 pb-8">
        ...
        <div className="glass-panel rounded-3xl shadow-elegant overflow-hidden grid md:grid-cols-2 max-w-5xl mx-auto">
          ...
          <div className={`p-7 md:p-10 flex flex-col justify-center ${isRtl ? "text-right" : "text-left"}`}>
            <h2 className="font-display text-3xl md:text-4xl font-bold mb-3" style={{ color: "hsl(var(--etimad-dark-green))" }}>
              {t.welcome}
            </h2>
              ...
              {t.features.map((f, i) => {
                ...
                return (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold" style={{ color: "hsl(var(--etimad-dark-green))" }}>{f.t}</div>
            ...
            <div dir={isRtl ? "rtl" : "ltr"} className="mt-5 rounded-xl bg-green-50 border border-green-200 border-s-4 border-s-green-600 p-4 shadow-sm">
              <div className="flex items-start gap-2.5">
                <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-green-600 text-white text-[11px] font-bold tracking-wide shrink-0 mt-0.5">
                  {t.disclaimerLabel}
                </span>
