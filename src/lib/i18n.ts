...
export const dict: Record<Lang, Entry> = {
  ...
  ar: {
    ...
    suggestions: [
      "ما هو قانون 244/2021؟",
      "اشرح إجراءات الشراء",
      "من يحق له تقديم العروض؟",
      "ما هي آليات الاعتراض؟",
    ],
  },
  fr: {
    title: "TAWREED",
    ...
    suggestions: [
      "Qu'est-ce que la loi 244/2021 ?",
      "Expliquez les procédures de passation",
      "Qui peut soumissionner ?",
      "Quels sont les mécanismes de recours ?",
    ],
  },
};
